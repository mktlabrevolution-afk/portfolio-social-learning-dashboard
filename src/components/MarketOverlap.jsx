  ...
  return (
    <div className="glass-panel">
      ...
      <div className="flex flex-col md:flex-row gap-lg">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center">
            ...
            <div className="flex flex-col gap-sm">
                {overlapData.map((item, idx) => (
                  <div key={idx} className="p-3 rounded-lg flex items-center justify-between" style={{ background: 'rgba(0,0,0,0.02)', borderLeft: `3px solid ${item.riskLevel === 'danger' ? 'var(--accent-ipp)' : '#ffaa00'}` }}>
                    <div>
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-4 rounded-xl" style={{ background: 'rgba(255,255,255,0.4)', border: '1px solid rgba(0,0,0,0.05)' }}>
